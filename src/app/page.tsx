    ...
    <div className={`translate-y-[-78px] flex flex-col space-y-32`}>
      ...
      <section className="max-w-screen-xl mx-auto px-6 md:px-14 xl:px-14 flex flex-col gap-10 md:space-y-0 md:flex-row">
        <div className="grid grid-cols-[1fr_2fr] gap-10">
          <h1 className="home-section-heading leading-none">Our mission</h1>
          <div>
            <p className="text-center md:text-left text-xl leading-tight">
      ...
      <section className="max-w-screen-xl mx-auto px-6 md:px-14 xl:px-14 w-full flex flex-col-reverse md:flex-row gap-14">
